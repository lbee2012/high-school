package com.example.LuyenTapLan2.de4.util;
...
public class HibernateConfig {
    ...
    static {
        ...
        properties.put(Environment.URL, "jdbc:sqlserver://localhost:1433;databaseName=LuyenTapLan2;encrypt=true;trustServerCertificate=true;");
        properties.put(Environment.USER, "sa");
        properties.put(Environment.PASS, "123");
        properties.put(Environment.SHOW_SQL, "true");

        conf.addAnnotatedClass(MonAn.class);
        conf.addAnnotatedClass(NhaHang.class);
